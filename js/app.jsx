...
function App() {
    ...
    // ========== AI Chat (non-streaming, with model badge) ==========
    const sendMessage = async (overrideText) => {
        ...
        try {
            const { content: rawReply, model: usedModel } = await window.OpenRouterService.chatCompletion({
            ...
            const { modifiedReply, actions } = window.processAgentSkills(rawReply);
